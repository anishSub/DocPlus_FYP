...
from .views import FindHospitalView, HospitalDetailView, HospitalRegistrationView, Hospital_successView, track_hospital_click
...
urlpatterns = [
  ...
  path('hospital/<int:pk>/visit-site/', track_hospital_click, name='track_hospital_click'),
